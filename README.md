...
- **Démos: des simulations, propositions d'implémentation...**
  ...
  - Liste de programmes réalisés sur la khanacademy de prime abord. Ils sont globalement listés des plus récents aux plus anciens
    - [Rendu 3D de fonctions de R^3 dans R](./demos/3d_graphics.js) (la troisième dimension est la dépendance au temps), [lien](https://www.khanacademy.org/computer-programming/3d-graphics-f-r3-r/5369745620975616)
    ...
    - [Interférences de deux sources cohérentes](/demos/interferences.js), [lien](https://www.khanacademy.org/computer-programming/interfrences/6432342133030912)
    ...
    - [Visualisation de l'algorithme de Dijkstra](./demos/dijsktra_europe.js) sur la carte de l'Europe [lien](https://www.khanacademy.org/computer-programming/dijkstra-algorithm/5030266773094400)
    ...
    - [Onde 1D](./demos/onde_1d.js), [lien](https://www.khanacademy.org/computer-programming/onde-1d/5778482964054016)
    - [Tracé d'une courbe de Bézier](./demos/bezier.js), [lien](https://www.khanacademy.org/computer-programming/bezier/6445157619515392)
    ...
    - [Jolies fonctions mathématiques](./demos/math_art.js) et [visualisation](https://www.khanacademy.org/computer-programming/math-art/5199950501429248) [lien](https://www.khanacademy.org/computer-programming/morse-encoder/6188517804523520)
    ...
    - [Visualisation d'une dérivée](./demos/derivee.js), [lien](https://www.khanacademy.org/computer-programming/drive/6071233141850112)
    - [Représentation d'une pièce de biais](./demos/piece_biais.js), [lien](https://www.khanacademy.org/computer-programming/pice-en-biais/5745223324581888)
    - [Visualisation du produit scalaire dans le plan](./demos/produit_scalaire.js), [lien](https://www.khanacademy.org/computer-programming/vecteurs-scalaires/5145961880141824)
    - [Calcul d'intersections dans le plan](./demos/intersections_plan.js), [lien](https://www.khanacademy.org/computer-programming/intersections/5054069548433408)
    - [Trajectoire d'un projectile](./demos/projectile.js), [lien](https://www.khanacademy.org/computer-programming/spin-off-of-physique-chute-libre/6093678011662336)
    - [Représentation d'un atome](./demos/bohr.js), [lien](https://www.khanacademy.org/computer-programming/atome/5982530092974080)
    - [Visualisation de l'effet Doppler](./demos/doppler.js), [lien](https://www.khanacademy.org/computer-programming/doppler/5053632495140864)
...
- **Jeux et autres**
  ...
  - Towers, [code](./jeux/tours.js) et [version en ligne](https://www.khanacademy.org/computer-programming/towers/6281707125784576)
  - Ciel avec bruit de Perlin, [code](./jeux/perlin_cloud.js) et [version en ligne](https://www.khanacademy.org/computer-programming/clouds-perlin-noise/4891686203080704)
